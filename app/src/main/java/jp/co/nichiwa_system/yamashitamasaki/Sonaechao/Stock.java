...
public class Stock extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //備蓄品の項目を取得する
        ItemClass[] item = {
                new ItemClass("ガスコンロ", "gas_number", R.drawable.gas, false, "個",this),
                ...
                new ItemClass("笛", "whistle_number", R.drawable.whistle, false,"個", this),
                new ItemClass("大人下着", "shitagi_number", R.drawable.otona, false,"枚", this),
                new ItemClass("子供下着", "kodomo_number", R.drawable.kodomo, false,"枚", this),
                new ItemClass("ティッシュ", "tissue_number", R.drawable.tissue, false,"箱", this),
                ...
                new ItemClass("充電器", "judenki_number", R.drawable.judenti, false,"個", this),
                new ItemClass("スプーン", "supun_number", R.drawable.spoon, false,"×１００本", this),
                new ItemClass("箸", "hasi_number", R.drawable.hasi, false,"×１００膳", this),
